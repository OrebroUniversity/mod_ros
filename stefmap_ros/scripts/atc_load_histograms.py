...
if __name__ == '__main__':
	...
	print("Loading day 1 histograms to FreMEn...", " from: ", output_file_name)
	...
	print("Loading day 2 histograms to FreMEn...", " from: ", output_file_name)
	os.system("rosrun stefmap_ros load_histograms.py "+output_file_name)
	print("Done")

	output_file_name = base_dir_o + "atc_2012_10_31_histograms.txt"
	print("Loading day 3 histograms to FreMEn...", " from: ", output_file_name)
	os.system("rosrun stefmap_ros load_histograms.py " + output_file_name)
	print("Done")

	output_file_name = base_dir_o + "atc_2012_11_04_histograms.txt"
	print("Loading day 4 histograms to FreMEn...", " from: ", output_file_name)
	os.system("rosrun stefmap_ros load_histograms.py " + output_file_name)
	print("Done")

	output_file_name = base_dir_o + "atc_2012_11_07_histograms.txt"
	print("Loading day 5 histograms to FreMEn...", " from: ", output_file_name)
	os.system("rosrun stefmap_ros load_histograms.py " + output_file_name)
	print("Done")

	output_file_name = base_dir_o + "atc_2012_11_11_histograms.txt"
	print("Loading day 6 histograms to FreMEn...", " from: ", output_file_name)
	os.system("rosrun stefmap_ros load_histograms.py " + output_file_name)
	print("Done")
